...
import {
  ...
  useLayoutEffect2
} from "./chunk-6OFGCVC7.js";
import {
  createContext2,
  createContextScope
} from "./chunk-N2GVWQPE.js";
import {
  Primitive,
  useComposedRefs
} from "./chunk-BFWWSSWM.js";
import {
  require_jsx_runtime
} from "./chunk-A4XIW7VS.js";
import "./chunk-MVWPOKMQ.js";
import {
  require_react
...
function createSlot(ownerName) {
  const Slot22 = React13.forwardRef((props, forwardedRef) => {
    ...
    React13.Children.forEach(children, (maybeSlottable) => {
      var _a;
    ...
    if (slottableElement) {
      slottableElement = React13.cloneElement(slottableElement, void 0, newChildren);
    } else if (
      // A `Slottable` was found but it didn't resolve to a single element (e.g.
      // it wrapped multiple elements, text, or a render-prop `child` that
      // wasn't an element). Don't fall back to treating the `Slottable` wrapper
      // itself as the slot target — throw a descriptive error below instead.
      !hasSlottable && React13.Children.count(children) === 1 && React13.isValidElement(children)
    ) {
    ...
    if (slottableElement.type !== React13.Fragment) {
      mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
    }
    return React13.cloneElement(slottableElement, mergedProps);
  });
...
var getSlottableElementFromSlottable = (slottable, child) => {
  if ("child" in slottable.props) {
    ...
    if (!React13.isValidElement(child2)) return null;
    return React13.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
  }
  return React13.isValidElement(child) ? child : null;
};
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime2.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React14.Children.map(children, (child) => (0, import_jsx_runtime2.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime2.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
