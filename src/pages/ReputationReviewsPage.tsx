...
const INITIAL_REVIEWS: ReviewItem[] = [
  {
    id: 'r1',
    author: 'Dr. Walter Evans (Jackson Medical Mall, Jackson MS)',
    rating: 5,
    date: 'Yesterday',
    source: 'Google',
    text: 'Environment Masters saved our healthcare facility from an emergency shutdown during the July heatwave. Marcus and Ray arrived in 20 minutes, repaired our 200-ton rooftop chiller, and kept surgical wings at 68°F. The premier commercial mechanical contractor in Mississippi.',
    status: 'NEEDS_REPLY',
  },
  {
    id: 'r2',
    author: 'Brenda Montgomery (Highland Colony Park, Ridgeland MS)',
    rating: 5,
    date: '3 days ago',
    source: 'Google',
    text: 'Environment Masters upgraded our 480V commercial switchgear and installed smart building surge protectors. The FoundryOS text updates and 1-tap SMS invoice link made project approval seamless.',
    status: 'REPLIED',
    replyText: 'Thank you Brenda! Environment Masters is proud to keep Highland Colony Commercial Park powered and running at peak efficiency.',
  },
  {
    id: 'r3',
    author: 'Caleb Thornton (Madison, MS Homeowner)',
    rating: 5,
    date: '1 week ago',
    source: 'Google',
    text: 'Priority One maintenance club member since 2018. Their technician arrived on time, diagnosed our dual heat pump capacitors, and inspected whole-home air filtration. 68 years in Jackson for a reason.',
    status: 'REPLIED',
    replyText: 'We appreciate your loyalty, Caleb! Thank you for trusting Environment Masters with your family home comfort.',
  },
];
