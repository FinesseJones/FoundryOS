        ...
        <AppLayout>
            <div className="space-y-6">
                ...
                <Card className="shadow-md">
                    ...
                    <CardContent>
                        {/* ULTIMATE FIX: Wrapping the whole thing in a Fragment wrapper for CardContent */}
                        <> 
                                                ...
                                                <tr key={user.id} className={`${user.status ? 'hover:bg-green-50' : 'hover:bg-red-50'}`}>
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                        ...
                                                        {currentUser.permissions.deleteCriticalRecords ? (
                                                            ...
                                                            <button disabled className="text-gray-400 cursor-not-allowed">No Delete Permission</button>
                                                        )}
                                                    </td>
                                                </tr >
                                            ))
